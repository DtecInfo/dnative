...
// q_datatable.sql.add('and u.cod_empresa = f.cod_empresa');
 ...
 if combo_status.SelectedValue='-1' then
  ...
  begin
    ...
    btn1 := '"<button type=\"buttom\" class=\"btn btn-xs btn-default\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar Usuário\" data-dismiss=\"modal\" onclick=\"SetaAcao(''EDITA'''
...
begin
   ...
   begin
    ...
    controller.DM.banco.ExecSQL(' update usuarios set nome= ' + quotedstr(edit_nome.Text) +
     ...
     addtoinitproc(swalSuccess('Sucesso!','Usuário Alterado com Sucesso!'));
   ...
   begin
       try
         ...
         AddToInitProc(swalSuccess('Sucesso!','Usuário cadastrado com sucesso, não esqueça de mudar sua senha padrão: '+ edit_login.Text + '123' ));
