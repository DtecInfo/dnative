...
begin
  ...
  AddToInitProc(swalSuccess('Confirmação', 'Senha resetada para o padrão: ''1234'' !!!'))
...
begin
  ...
  begin
    ...
    begin
      ...
      html := html + '                                                    <label>Data Solicitação</label> ' + SLineBreak;
      ...
      html := html + '                                            <div class="col-md-4"> ' + SLineBreak;
      html := html + '                                                <div class="form-group"> ' + SLineBreak;
      html := html + '                                                    <label>Solicitação</label> ' + SLineBreak;
      ...
      html := html + '                                                <div class="form-group"> ' + SLineBreak;
      html := html + '                                                    <label>Descrição do Problema</label> ' + SLineBreak;
      ...
      html := html + '                                            <div class="col-md-6"> ' + SLineBreak;
      html := html + '                                                <div class="form-group"> ' + SLineBreak;
      html := html + '                                                    <label>Descrição da Solução</label> ' + SLineBreak;
    ...
    begin
      ...
      html := html + '                                                NÃO HÁ CHAMADOS COM ESSES FILTROS !!!' + SLineBreak;
      html := html + '                                            </div> ' + SLineBreak;
      html := html + '                                        </div> ' + SLineBreak;
    end;
  ...
  // Clicou em Resetar a Senha
  if Trim(Copy(IWAcao.Text,1,5)) = 'Senha' then
  begin
    WebApplication.CallBackResponse.AddJavaScriptToExecute(swalConfirm('CONFIRMAÇÃO', 'Deseja resetar a sua Senha ?', 'warning', 'Resetar', 'Cancelar', 'BTNSENHA'));
  end;
end;
