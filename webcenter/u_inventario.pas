...
//    [rfReplaceAll]) + '%'' ) ');
  ...
  begin
    ...
    btn1 := '   "<div class=\"btn-group\">' +
      ...
      ')\" > <i class=\"fa  fa-edit (alias)\"></i> Passo 2 - Primeira Digitação </a></li> '
      + '   <li><a onclick=\"SetaAcao(''INV02''' + ',' + ID +
      ')\" > <i class=\"fa fa-print\"></i> Passo 3 - Divergência 1ª Contagem </a></li> ' +
      '   <li><a onclick=\"SetaAcao(''INV03''' + ',' + ID +
      ')\" > <i class=\"fa  fa-edit (alias)\"></i> Passo 4 - Segunda digitação </a></li> '
      + ' <li><a onclick=\"SetaAcao(''INV04''' + ',' + ID +
      ')\" > <i class=\"fa fa-print\"></i> Passo 5 - Imprimir Divergência </a></li>  '
      + ' <li><a onclick=\"SetaAcao(''INV05''' + ',' + ID +
      ')\" > <i class=\"fa  fa-edit (alias)\"></i> Passo 6 - Terceira Digitação </a></li> '
      + ' <li><a onclick=\"SetaAcao(''INV06''' + ',' + ID +
      ')\" > <i class=\"fa fa-print\"></i>Passo 7 - Imprimir Divergência </a></li> ' +
      ...
      ')\" > <i class=\"fa fa-thumbs-o-up\"></i> Final - Acertar Estoque(Perigoso, não tem volta) </a></li>  ' +
