...
begin
  inherited;
   ATag.Add('placeholder="Informe um CNPJ válido"');
...
begin
  inherited;
ATag.Add('placeholder="Informe um DDD válido"');
   ATag.Add(' style="text-align:right" ');
...
begin
  inherited;
  ATag.Add('placeholder="Informe um CEL válido"');
   ATag.Add(' style="text-align:right" ');
...
begin
  inherited;
 ATag.Add('placeholder="Informe um ZAP válido"');
   ATag.Add(' style="text-align:right" ');
   ATag.Add('data-inputmask="''mask'': ''99999-9999''" data-mask');
end;
     ...
     begin
        ...
        if combo_tipo.SelectedValue='F' then
           begin
            ...
            //se for pessoa fisica dados juridicos irão null
...
begin
  inherited;
ATag.Add('placeholder="Informe um CEP válido"');
   ATag.Add(' style="text-align:right" ');
...
begin
  ...
  ATag.Add(' style="text-align:right" ');
  ATag.Add('placeholder="Informe um CPF válido"');
