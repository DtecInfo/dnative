...
begin
  ...
  begin
    WebApplication.CallBackResponse.AddJavaScriptToExecute(swalConfirm('CONFIRMAÇÃO', 'Deseja resetar a Senha do cliente nº '+Trim(Copy(IWAcao.Text,6,50)), 'warning', 'Resetar', 'Cancelar', 'BTNSENHA'));
  end;
...
begin
  ...
  begin
    ...
    html := html + '<table id="GRID" class="table table-bordered table-striped table-hover"> '+SLineBreak+
                   ...
                   '            <th>Razão Social do Cliente</th> '+SLineBreak+
