...
interface
  ...
  function swalConfirm(pTitulo, pTexto : String; pTipo: String = 'success'; pBotaoSim : String = 'Sim'; pBotaoNao : String = 'Não'; pEventoSim : String = 'BTNFAZERLOGOUT';pEventoNao :string ='BTNFAZERLOGOUT2'): String;
